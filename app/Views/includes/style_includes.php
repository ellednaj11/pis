...
<title>Secured Document Management System</title>

<link rel="icon" href="<?= base_url() ?>/public/dist/img/aes/CICTLogo.gif">
...
<link rel="stylesheet" href="<?= base_url() ?>/public/dist/css/custom/homepage.css">

<link rel="stylesheet" href="<?= base_url() ?>/public/plugins/sanspro/sanspro.min.css">
<!-- Font Awesome Icons -->
<link rel="stylesheet" href="<?= base_url('public/plugins/fontawesome-free/css/all.min.css') ?>">
<!-- Theme style -->
<link rel="stylesheet" href="<?= base_url('public/dist/css/adminlte.min.css') ?>">
